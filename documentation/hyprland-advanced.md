...
`Super + Shift + Q/W/E/R/T/P` - terminal multiplexer [zellij](https://github.com/zellij-org/zellij), **switch** window axis, yazi, reload wallpaper, freeze a wayland game, move to private workspace.<br>
